...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($row['count'] > 0) {
        ...
        $stmt = $conn->prepare("INSERT INTO Groups (group_name, parent_group_id, description, group_type, created_at, updated_at) VALUES (?, ?, ?, ?, NOW(), NOW())");
...
<head>
    ...
    <link rel="stylesheet" href="create_grp_style.css">
</head>
<body>
